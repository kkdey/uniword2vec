...
void tmcn_word2vec(char *train_file0, char *output_file0_in, char *output_file0_out,
...
void CWrapper_word2vec(char **train_file, char **output_file_in, char **output_file_out,
                       char **binary, char **dims, char **threads,
                       char **window, char **classes, char **cbow, char **min_count, char **iter, char **neg_samples)
{
    tmcn_word2vec(*train_file, *output_file_in, *output_file_out, *binary, *dims,
                  *threads,*window,*classes,*cbow,*min_count,*iter, *neg_samples);
}
